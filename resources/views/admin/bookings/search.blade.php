...
<div class="card">
    ...
    <div class="card-body">
        ...
        @if($rooms !== null)
            ...
            @else
                <p class="text-center">Il n’y a pas de chambres disponibles à l’heure que vous avez choisie</p>
            @endif
        @endif
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="submitBooking">Effectuer</button>
